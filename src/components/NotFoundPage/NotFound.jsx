...
// Animation loop with enhanced zoom effect and constellations
    ...
    animate(0);
    return(
        <div className={"bg-black h-[100svh] text-white flex  justify-center justify-items-center"} >
            <h1 className={"text-center text-6xl font-bold mb-10 self-center-safe"}>404 Not Found</h1>
        </div>
    )
}